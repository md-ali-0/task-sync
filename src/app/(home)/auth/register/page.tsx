            ...
            <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
                ...
                <div className="relative z-20 mt-auto">
                    <blockquote className="space-y-2">
                        <p className="text-lg">
                            &ldquo;This task management app has revolutionized
                            the way our team works. It&apos;s intuitive,
                            powerful, and keeps us all on the same
                            page.&rdquo;
                        </p>
            ...
            <div className="mt-6 flex flex-col items-center text-center text-sm text-muted-foreground lg:hidden">
                <blockquote className="max-w-sm space-y-2 px-4">
                    <p className="text-base font-medium">
                        &ldquo;This task management app has revolutionized the
                        way our team works. It&apos;s intuitive, powerful, and
                        keeps us all on the same page.&rdquo;
                    </p>
                    <footer className="text-sm">Sofia Davis</footer>
                </blockquote>
            </div>
